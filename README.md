...
خط مبنا فقط میانگین تغییر چهار قیمت بسته‌شدن اخیر را تا افق چهار کندل ادامه می‌دهد و هیچ پارامتری را روی دورهٔ آزمون یاد نمی‌گیرد. هر دو از تابع تصمیم و بازپخش یکسان استفاده می‌کنند؛ موقعیت‌هایشان جداگانه پیش می‌رود و ممکن است تعداد یا زمان معاملات یکسان نباشد. گزارش شامل دوره، پوشش اسپرد، تعداد معاملات، R خالص، افت سرمایه و محدودیت‌های مقایسه است. هیچ فایل یا مدل زنده‌ای را عوض نمی‌کند.
